...
#define FAST_HEADER_SPACE         (FAST_ONE_SPACE)    // 1578
...
#define FAST_REPEAT_DISTANCE      (FAST_REPEAT_PERIOD - (40 * FAST_UNIT)) // 29 ms
#define FAST_MAXIMUM_REPEAT_DISTANCE (FAST_REPEAT_DISTANCE + 10000) // 47.5 ms

/*
 * Definitions to switch between FAST and NEC/ONKYO timing with the same code.
 */
#if defined(USE_FAST_PROTOCOL)
#define DISABLE_NEC_REPEAT_SUPPORT    // Disables detection of special short frame NEC repeats. Saves 40 bytes program memory.
